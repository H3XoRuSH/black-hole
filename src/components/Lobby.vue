    ...
    <div class="w-full max-w-md bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-200/80 dark:border-slate-700 p-5 sm:p-8 text-center">
      <div v-if="roomKey">
        ...
        <div
          ...
          class="w-full mb-4 bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700/50 text-amber-800 dark:text-amber-200 rounded-xl p-3 text-xs sm:text-sm font-medium flex items-center justify-center space-x-2 animate-pulse"
        >
        ...
        <!-- Players List -->
        <div class="mt-6 border-t border-gray-100 dark:border-slate-700 pt-6 text-left">
          <h4 class="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Players ({{ players.length }}/{{ maxPlayers }})</h4>
          ...
          <div class="space-y-3 pt-4 border-t border-gray-100 dark:border-slate-700">
            ...
            <button
              ...
              :class="canStartGame ? 'bg-indigo-600 hover:bg-indigo-700 cursor-pointer' : 'bg-gray-300 dark:bg-slate-600 text-gray-500 dark:text-gray-400 cursor-not-allowed'"
            >
              Start Game
            </button>
          </div>
      ...
      <div v-if="roomKey" class="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-100 dark:border-slate-700">
        <router-link
          to="/menu"
          class="inline-block w-full bg-gray-100 dark:bg-slate-700 hover:bg-gray-200 dark:hover:bg-slate-600 text-gray-700 dark:text-gray-300 font-bold py-2.5 sm:py-3 px-4 rounded-xl transition-all duration-200"
        >
